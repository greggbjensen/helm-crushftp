...
3. Push the image to Dockerhub
    ...
    ```bash
    docker push greggbjensen/crushftp:1.0.0
    ```
...
4. Update index.yaml:
    ...
    ```bash
    helm repo index --url https://github.com/greggbjensen/helm-crushftp/releases/download/1.0.0 --merge index-previous.yaml .
    ```
