...
3. Push the image to Dockerhub
    ...
    ```bash
    docker push greggbjensen/crushftp:0.1.0-preview9
    ```
...
4. Update index.yaml:
    ...
    ```bash
    helm repo index --url https://github.com/greggbjensen/helm-crushftp/releases/download/0.1.0-preview9 --merge index-previous.yaml .
    ```
